 ...
 *
 * @category Class
 * @description A personal API token&#39;s own metadata — never the token value itself, which only ever appears once, in APITokenCreateResponse&#39;s own response body at creation time.
 * @package  ForgeDashboard\Generated
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class APIToken implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets label
     *
     * @param string $label The name given at creation time, so a list of several is tellable apart.
     *
     * @return self
     */
     ...
     * Sets last_used_at
     *
     * @param \DateTime|null $last_used_at Omitted if this token has never authenticated a request yet.
     *
     * @return self
     */
