...
docker run --rm --user "$(id -u):$(id -g)" \
  ...
  -g php \
  -o /local/generated \
  --additional-properties="invokerPackage=ForgeDashboard\\Generated,packageName=ForgeDashboardGenerated,composerPackageName=alrayyes/forge-dashboard-sdk-php,artifactVersion=0.1.0,library=guzzle,licenseName=MIT,srcBasePath=src" \
